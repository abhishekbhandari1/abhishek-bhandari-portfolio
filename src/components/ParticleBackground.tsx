...
const ParticleBackground = () => {
  ...
  useEffect(() => {
    ...
    updateRenderState();
    desktopQuery.addEventListener('change', updateRenderState);
    reducedMotionQuery.addEventListener('change', updateRenderState);

    return () => {
      desktopQuery.removeEventListener('change', updateRenderState);
  ...
  useEffect(() => {
    ...
    // Create particles
    const particleCount = window.innerWidth >= 1280 ? 36 : 24;
