...
const StatsCounter = () => {
  ...
  const stats: Stat[] = [
    { icon: TrendingUp, value: 1, suffix: '+', label: 'Years Learning & Building', color: 'text-primary' },
    { icon: Award, value: 12, suffix: '+', label: 'Projects & Labs', color: 'text-primary' },
    { icon: Users, value: 95, suffix: '%', label: 'Pipeline Success Rate', color: 'text-primary' },
    { icon: Zap, value: 60, suffix: '%', label: 'Less Manual Deployment Work', color: 'text-primary' }
  ];
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-4 sm:p-5 md:p-6 text-center relative z-10">
