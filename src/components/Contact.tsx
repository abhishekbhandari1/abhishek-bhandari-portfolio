      ...
      <div className="container-custom">
        <div className="text-center mb-12 md:mb-16 scroll-animate animate-fade-in">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
            Open to junior DevOps roles, internships, and cloud automation collaborations. Feel free to reach out anytime.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-6">
                Whether you're hiring for an entry-level DevOps position, looking for project support, or just want to connect, I’d love to hear from you.
              </p>
            </div>
                  ...
                  <CardContent className="p-4 md:p-6">
                    <a href={contact.href} className="flex items-center gap-3 md:gap-4 group">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm md:text-base font-medium group-hover:text-primary transition-colors duration-300 break-all sm:break-normal">
                          {contact.value}
                        </p>
                      </div>
                    </a>
