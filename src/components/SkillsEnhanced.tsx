...
const SkillsEnhanced = () => {
  ...
  const topSkills = [
    ...
    { name: 'Terraform', level: 70, color: '#7B42BC', category: 'IaC' },
    { name: 'Kubernetes', level: 68, color: '#326CE5', category: 'Container' },
    { name: 'Docker', level: 78, color: '#2496ED', category: 'Container' },
    { name: 'Jenkins', level: 65, color: '#D24939', category: 'CI/CD' },
    { name: 'GitLab CI/CD', level: 70, color: '#FCA121', category: 'CI/CD' },
    { name: 'GitHub Actions', level: 78, color: '#2088FF', category: 'CI/CD' },
    { name: 'Prometheus', level: 66, color: '#E6522C', category: 'Monitoring' },
    { name: 'Grafana', level: 68, color: '#F46800', category: 'Monitoring' },
    { name: 'Python', level: 72, color: '#3776AB', category: 'Language' },
    { name: 'Azure', level: 55, color: '#0078D4', category: 'Cloud' },
    { name: 'GCP', level: 58, color: '#4285F4', category: 'Cloud' },
    { name: 'Bash', level: 75, color: '#4EAA25', category: 'Language' }
  ];
