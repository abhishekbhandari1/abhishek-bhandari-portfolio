        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Junior DevOps Engineer focused on CI/CD, cloud infrastructure fundamentals, and automation for reliable software delivery.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-muted-foreground">
              ...
              <a
                href="mailto:workwithabhishek3@gmail.com"
                className="block hover:text-primary transition-colors duration-300 break-all"
              >
